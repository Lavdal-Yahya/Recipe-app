...
class BevragesScreen extends StatefulWidget {
  const BevragesScreen({super.key});

  @override
  State<BevragesScreen> createState() => _BevragesScreenState();
}

class _BevragesScreenState extends State<BevragesScreen> {
  ...
  Future<void> getRecipes() async {
    try {
      _recipes = await RecipesApi.getRecipe("beverage");
    } catch (e) {
      _recipes = [];
