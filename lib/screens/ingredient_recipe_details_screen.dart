...
class IngredientRecipeDetailsScreen extends StatefulWidget {
  final int recipeId;

  const IngredientRecipeDetailsScreen({super.key, required this.recipeId});

  @override
  State<IngredientRecipeDetailsScreen> createState() => _IngredientRecipeDetailsScreenState();
}

class _IngredientRecipeDetailsScreenState extends State<IngredientRecipeDetailsScreen> {
